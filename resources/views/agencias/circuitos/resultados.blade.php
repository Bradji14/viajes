...
@section('title', 'Circuitos destino')
...
@section('scripts')
  <script>
    ...
    let items = '<div class="col-sm-12 col-md-6 col-lg-4 cluster-item">'+
      '<div class="card">'+
        '<img src="https://media.staticontent.com/media/pictures/3e3965df-b8da-4f42-9b58-66a9bc60a3eb/409x210?op=NONE&enlarge=false&gravity=ce_0_0&quality=80&dpr=1.5" class="card-img-top" alt="..." height="249px" width="486px">'+
        '<div class="card-body">'+
          '<h5 class="card-title">Card title</h5>'+
          '<p class="card-text">Some quick example text to build on the card title and make up the bulk of the cards content.</p>'+
          '<a href="'+(path+'/exampleID/url-tag')+'" class="btn btn-primary" target="_blank">Go somewhere</a>'+
        '</div>'+
      '</div>'+
    '</div>';
